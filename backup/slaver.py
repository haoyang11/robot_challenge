...
Use Slaver identification to move. 2018.8.9
...
def master_callback(msg):
    global slaverInstruction,master_rev
    if msg.data == 'attack':
...
pub_slaver = rospy.Publisher("/tb"+tb_name+"/isSlaverFindBall",std_msgs.msg.Bool,queue_size=1)
rospy.Subscriber("/tb"+tb_name+'/masterInstruction',std_msgs.msg.String,master_callback)
...
masterFindBall, slaverFindBall = 0, 0
masterInstruction, slaverInstruction = 'attack', 'attack'
