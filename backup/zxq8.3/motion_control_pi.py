...
def init():
    ...
    rospy.Subscriber("/point_control", Float64MultiArray, point_control_callback)
    pub_point_state=rospy.Publisher("/point_state", Bool, queue_size=1)
    rospy.Subscriber("/rotate_control", Float64MultiArray, rotate_control_callback)
    pub_rotate_state=rospy.Publisher("/rotate_state", Bool, queue_size=1)
