...
def init():
    global cmd_vel,position,move_cmd,odom_frame,pub_reset,rpy_start,tf_listener,base_frame,pub_point_control,pub_rotate_control
    ...
    pub_point_control=rospy.Publisher("/point_control", Float64MultiArray,queue_size=1)
    rospy.Subscriber("/point_state", Bool,point_state_callback )
    pub_rotate_control=rospy.Publisher("/rotate_control", Float64MultiArray,queue_size=1)
    rospy.Subscriber("/rotate_state", Bool, rotate_state_callback)
