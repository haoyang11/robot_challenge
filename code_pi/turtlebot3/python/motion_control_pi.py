...
Change PointMove(x,y,z) to PointMove(x,y, z=-999)
if z is not default value(-999), rotate to z.

Update time: 2018.8.14
...
def PointMove(x,y,z=-999):
    print "--> Move to point (", x, ", ",  y, ")."
    if z != -999:
        print "--> And then rotate to: ", z, " degree."
    t = time.time()
    rate = rospy.Rate(20)
